                ...
                <div class="md:flex md:items-center md:justify-between">
                    <div class="flex justify-between gap-6 md:gap-0 items-center">
                        ...
                        <div class="flex md:hidden">
                            <button type="button" @click="navState.isActive = !navState.isActive" class="flex items-center focus:outline-none" aria-label="toggle profile dropdown">
                    ...
                    <div :class="[navState.isActive ? 'translate-x-0 opacity-100 shadow-sm md:shadow-none backdrop-blur-md bg-white/90 dark:bg-dark-mixed-100/80' : 'opacity-0 -translate-x-full']" class="absolute inset-x-0 z-20 w-full px-6 py-4 transition-all duration-300 ease-in-out md:flex-1 md:flex md:justify-between md:mt-0 mt-4 md:p-0 md:top-0 md:relative md:bg-transparent md:w-auto md:opacity-100 md:translate-x-0 md:items-center">
                        ...
                        <div class="flex items-center mt-4 md:mt-0 md:pl-12">

                            <button type="button" class="flex items-center  focus:outline-none" aria-label="toggle profile dropdown">
                                <div class="w-8 h-8 overflow-hidden border-2 border-gray-400 rounded-full">
                                    <img src="https://images.unsplash.com/photo-1517841905240-472988babdf9?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=334&q=80" class="object-cover w-full h-full" alt="avatar">
                                </div>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 text-gray-800 dark:text-gray-200 hidden md:block md:ml-2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                                </svg>

                                <h3 class="mx-2 text-gray-700 dark:text-gray-200 md:hidden">Jeremias Marques</h3>
                            </button>
                        </div>
                    </div>
                </div>
