<template>
<div class="publi-card drop-shadow-xs bg-[#fcfcfc] flex flex-col px-6 py-6 lg:px-8 border rounded-xl">
    ...
    <div class="publi-stats flex justify-between items-center w-full">
        <div class="left flex items-center gap-6">
            <div class="likes flex items-center gap-2">
                <button type="button" v-if="!isLiked">
                    <Icon name="Like" color="text-gray-800" size="5" />
                </button>
        ...
        <div class="right flex items-center">
            <router-link 
                ...
                class="tag flex items-center justify-center py-1 px-2 rounded-full bg-gray-100"
                >
