<template>
    <section
      class="relative z-10 overflow-hidden bg-white py-20 dark:bg-dark-mixed-100 lg:py-[160px] -scroll-mt-[70px]"
      id="contact"
    >
        <div class="container mx-auto">
            <div class="flex flex-wrap lg:justify-between">
                <div class="w-full px-6 lg:w-1/2 xl:w-6/12">
                    <div
                    ...
                    >
                        ...
                        <div class="mb-8 flex w-full max-w-[370px]">
                            ...
                            <div class="w-full">
                                <h4 class="mb-1 text-xl font-bold text-dark dark:text-gray-50">
                                    Nossa localização
                                </h4>
                ...
                <div class="relative xl:mr-8 mr-0 w-full px-6 lg:w-1/2 xl:w-5/12">
                    <ContactForm />
                    <div>
                        <span
                            ...
                            data-aos-duration="800"
                        >
                            <img src="../../assets/images/logo-icon.svg" class="w-auto h-32" alt="">
                        </span>
                        <span
                            class="absolute -right-2 top-[90px] z-[-1]"
                            data-aos="fade"
                            data-aos-delay="650"
                            data-aos-easing="ease-out"
                            data-aos-duration="800"
                        ...
                        <span
                            class="absolute -bottom-8 md:bottom-20 -left-5 z-[-1]"
                            data-aos="fade"
                            data-aos-delay="100"
                            data-aos-easing="ease-out"
                            data-aos-duration="800"
...
import { Home, Mail, PhoneOutgoing } from 'lucide-vue-next';
</script>